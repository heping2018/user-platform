...
//        Connection connection = driver.connect("jdbc:derby:/db/user-platform;create=true", new Properties());
        ...
        //User{id=39, name='D', password='******', email='d@gmail.com', phoneNumber='4'}
        User user1 = new User();
        user1.setEmail("d@gmail.com");
        user1.setName("E");
        user1.setPassword("******&&");
        user1.setPhoneNumber("5");
        databaseUserRepository.save(user1);
        Statement statement = connection.createStatement();
        // 删除 users 表
         System.out.println(statement.execute("SELECT * FROM users")); // false
        // 创建 users 表
